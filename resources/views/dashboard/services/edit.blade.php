<x-app-layout>
    ...
    <div class="p-2 sm:p-6">
        <div class="p-2 sm:p-6 bg-white rounded-md">
            <h1 class="text-xl mb-4 text-center sm:text-left">'{{$service->title}}' Service Information</h1>
            <p>(<span class="text-red-500 mb-4">*</span>) marked fields are required.</p>

            <form method="POST" action="{{ route('services.update',$service->id) }}" id="service-store" enctype="multipart/form-data" >
                @csrf
                @method('PATCH')
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="col-span-2">
                        ...
                        <x-textarea id="short_description" class="block mt-2 w-full" name="short_description" required
                            autocomplete="short_description">{!!$service->short_description !!}</x-textarea>
                    ...
                    <div class="col-span-2">
                        ...
                        <x-textarea id="description" class="block mt-2 w-full" name="description" required
                            autocomplete="description">{!! $service->description!!}</x-textarea>
