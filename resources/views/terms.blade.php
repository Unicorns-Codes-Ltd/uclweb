<x-guest-layout>
    ...
    <section class="mt-16">
        <div class="pt-16 pb-8 sm:py-24 bg-no-repeat bg-cover bg-center" style="background-image: url({{asset('img/about-hero.jpg')}});">
            <div class=" ">
                <h2 class="text-3xl lg:text-7xl text-white font-bold uppercase text-center">Terms & Conditions</h2>
            </div>
        </div>
    </section>
    <!-- =================About-Hero start======================= -->
    ...
    <section>
        <div class=" bg-white pt-10 pb-16 lg:pt-20 lg:pb-24 px-3 lg:px-0">
            <div class="max-w-7xl mx-auto text-nblue mb-10">
                <h3 class="text-2xl text-dgreen my-4"><strong>Welcome to Software Builders Ltd!</strong></h3>

                <p>These terms and conditions outline the rules and regulations for the use of Software Builders Ltd's
                    Website, located at http://softbuild.shadapixel.com/.</p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Software Builders Ltd if you do not agree to take all of the terms and conditions stated on this
                    page.</p>
                ...
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                    ...
                    with and subject to, prevailing law of bd. Any use of the above terminology or other words in the
                    singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore
                    as referring to same.</p>

                <h3 class="text-2xl text-dgreen my-4"><strong>Cookies</strong></h3>

                <p>We employ the use of cookies. By accessing Software Builders Ltd, you agreed to use cookies in
                    agreement with the Software Builders Ltd's Privacy Policy. </p>
                ...
                <h3 class="text-2xl text-dgreen my-4"><strong>License</strong></h3>

                <p>Unless otherwise stated, Software Builders Ltd and/or its licensors own the intellectual property
                    rights for all material on Software Builders Ltd. All intellectual property rights are reserved. You
                    may access this from Software Builders Ltd for your own personal use subjected to restrictions set
                    in these terms and conditions.</p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from Software Builders Ltd</li>
                    <li>Sell, rent or sub-license material from Software Builders Ltd</li>
                    <li>Reproduce, duplicate or copy material from Software Builders Ltd</li>
                    <li>Redistribute content from Software Builders Ltd</li>
                </ul>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. Software Builders Ltd does not filter, edit, publish or review
                    Comments prior to their presence on the website. Comments do not reflect the views and opinions of
                    Software Builders Ltd,its agents and/or affiliates. Comments reflect the views and opinions of the
                    person who post their views and opinions. To the extent permitted by applicable laws, Software
                    Builders Ltd shall not be liable for the Comments or for any liability, damages or expenses caused
                    and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
                    this website.</p>

                <p>Software Builders Ltd reserves the right to monitor all Comments and to remove any Comments which can
                ...
                <p>You hereby grant Software Builders Ltd a non-exclusive license to use, reproduce, edit and authorize
                    others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>

                <h3 class="text-2xl text-dgreen my-4"><strong>Hyperlinking to our Content</strong></h3>
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of Software Builders Ltd; and (d) the link is in the context of general resource
                    information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Software Builders Ltd. Please include your name,
                ...
                <p>No use of Software Builders Ltd's logo or other artwork will be allowed for linking absent a
                    trademark license agreement.</p>

                <h3 class="text-2xl text-dgreen my-4"><strong>iFrames</strong></h3>
                ...
                <h3 class="text-2xl text-dgreen my-4"><strong>Content Liability</strong></h3>
                ...
                <h3 class="text-2xl text-dgreen my-4"><strong>Reservation of Rights</strong></h3>
                ...
                <h3 class="text-2xl text-dgreen my-4"><strong>Removal of links from our website</strong></h3>
                ...
                <h3 class="text-2xl text-dgreen my-4"><strong>Disclaimer</strong></h3>
